...
public class SearchActivity extends AppCompatActivity {
    ...
    private void search(String searchQuery){
        final JsonArrayRequest jsonObjectRequest = new JsonArrayRequest(Request.Method.GET, SEARCH_URL + searchQuery, null, new Response.Listener<JSONArray>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if(networkResponse == null){
                    ...
                    Toast.makeText(SearchActivity.this, "Unable to update feed. Check internet connection", Toast.LENGTH_SHORT).show();
                }
            }
        }) {
            @Override
        ...
        RequestQueue requestQueue = RequestSingleton.getInstance(SearchActivity.this.getApplicationContext()).getRequestQueue();
        RequestSingleton.getInstance(SearchActivity.this).addToRequestQueue(jsonObjectRequest);
    }
}
